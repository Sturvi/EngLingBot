...
public class TemplateMessagesSender {
    ...
    public void sendAddWordMessage(Long chatId) {
        ...
        var keyboard = inlineKeyboardMarkupFactory.getRandomWordsKeyboard();
        ...
        telegramMessageService.sendMessageWithKeyboard(chatId, message, keyboard);
    }
    ...
    public void sendNoWordToSendMessage(Long chatId, UserWordState... types) {
        ...
        if (types.length == 1) {
            ...
            } else if (types[0] == UserWordState.LEARNING) {
                telegramMessageService.sendMessageToUser(
                        chatId,
